...
public class Generator {
   ...
   public Generator(LinearCongruentialGenerator generator) {
   ...
   private BigInteger[] generatePrimes512() {
      ...
      primes[index] = BigInteger.probablePrime(t.get(index), ThreadLocalRandom.current());
      int m = index - 1;
      boolean flag = true;
      do {
   ...
   BigInteger generateA(BigInteger p, BigInteger q) {
      ...
      do {
         do {
            d = new BigInteger(p.bitLength(), ThreadLocalRandom.current());
